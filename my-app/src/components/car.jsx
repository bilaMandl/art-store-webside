export const Car = () => {
    return <svg className="truck" viewBox="0 0 48 24" width="38px" height="14px">
     <g fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" transform="translate(0,2)">
         <g className="truck__body">
             ...
             <polyline className="truck__line" points="43 8,31 8" stroke-dasharray="10 2 10 2 10 2 10 2 10 2 10 26" />
             <polyline className="truck__line" points="47 10,31 10" stroke-dasharray="14 2 14 2 14 2 14 2 14 18" />
         </g>
